...
{	
	...
	String u1="update client_account_details set balance=balance-"+amt+"where accno='"+tra_det[0]+"'";
	String u2="update client_account_details set balance=balance+"+amt+"where accno='"+tra_det[1]+"'";
